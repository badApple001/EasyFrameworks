//==========================
// - FileName:      Assets/Frameworks/Scripts/CatAsset/Runtime/Loader/BaseAssetLoader.cs
// - Created:       ChenJC	
...
namespace CatAsset.Runtime
{
    ...
    public abstract class BaseAssetLoader
    {
        ...
        /// 同步加载资源
        /// </summary>
        public virtual AssetHandler<T> LoadAsset<T>( string assetName, CancellationToken token = default,
            TaskPriority priority = TaskPriority.Low )
        {
            return InternalLoadAsset<T>( assetName, token, priority );
        }
        ...
        /// 同步加载资源接口
        /// </summary>
        protected abstract AssetHandler<T> InternalLoadAsset<T>( string assetName, CancellationToken token,

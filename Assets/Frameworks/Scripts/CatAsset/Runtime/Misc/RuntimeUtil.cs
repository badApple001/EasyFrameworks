//==========================
// - FileName:      Assets/Frameworks/Scripts/CatAsset/Runtime/Misc/RuntimeUtil.cs
// - Created:       ChenJC	
...
namespace CatAsset.Runtime
{
    ...
    public static class RuntimeUtil
    {
        ...
        public static string JoinPath( string WebServerDirectory, string path )
        {
            string result = GetRegularPath( Path.Combine( WebServerDirectory, path ) );
            return result;
        }

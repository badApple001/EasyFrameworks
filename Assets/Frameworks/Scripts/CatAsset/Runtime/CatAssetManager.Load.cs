//==========================
// - FileName:      Assets/Frameworks/Scripts/CatAsset/Runtime/CatAssetManager.Load.cs
// - Created:       ChenJC	
...
namespace CatAsset.Runtime
{
    public static partial class CatAssetManager
    {
        ...
        /// 同步加载资源
        /// </summary>
        public static AssetHandler<T> LoadAsset<T>( string assetName, CancellationToken token = default,
            TaskPriority priority = TaskPriority.Low )
        {
            return assetLoader.LoadAsset<T>( assetName, token, priority );
        }

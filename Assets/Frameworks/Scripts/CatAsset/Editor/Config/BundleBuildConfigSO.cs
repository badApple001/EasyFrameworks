//==========================
// - FileName:      Assets/Frameworks/Scripts/CatAsset/Editor/Config/BundleBuildConfigSO.cs
// - Created:       ChenJC	
...
namespace CatAsset.Editor
{
    ...
    public class BundleBuildConfigSO : ScriptableObject
    {
        ...
        /// 资源包构建输出根目录
        /// </summary>
        public string OutputRootDirectory = "./Library/AssetBundlesOutput";
        ...
        private void InitBundleBuildInfo( bool isRaw )
        {
            ...
            {
                if ( Directories[ i ].DirectoryObj == null )
                {

//==========================
// - FileName:      Assets/Frameworks/Scripts/CatAsset/Editor/BuildPipeline/BuildPipeline.cs
// - Created:       ChenJC	
...
namespace CatAsset.Editor
{
    ...
    public static class BuildPipeline
    {
        ...
        public static ReturnCode BuildBundles( BuildTarget targetPlatform, bool isBuildPatch )
        {
            ...
            //Copy到WebServer目录
            taskList.Add( new CopyToWebServerDirectory() );
            taskList.Add( new WriteManifestFile() );
            ...
            //服务器版本号
            File.WriteAllText( "./WebServer/version.txt", EditorJsonUtility.ToJson( new WebVersion
            {

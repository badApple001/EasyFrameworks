//==========================
// - FileName:      Assets/Frameworks/Scripts/CatAsset/Editor/Window/ProfilerInfoWindow/ProfilerInfoWindow.cs
// - Created:       ChenJC	
...
namespace CatAsset.Editor
{
    ...
    public class ProfilerInfoWindow : EditorWindow
    {
        ...
        [MenuItem("Frameworks/AssetBundle工具界面/打开调试分析器窗口", priority = 1)]

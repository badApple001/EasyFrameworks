//==========================
// - FileName:      Assets/Frameworks/Scripts/CatAsset/Editor/Window/DifferenceBundleWindow/DifferenceBundleWindow.cs
// - Created:       ChenJC	
...
namespace CatAsset.Editor
{
    ...
    public class DifferenceBundleWindow : EditorWindow
    {
        ...
        [MenuItem("Frameworks/AssetBundle工具界面/打开差异包提取窗口", priority = 2)]

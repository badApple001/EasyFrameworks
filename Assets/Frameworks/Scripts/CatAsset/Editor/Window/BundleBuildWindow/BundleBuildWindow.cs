//==========================
// - FileName:      Assets/Frameworks/Scripts/CatAsset/Editor/Window/BundleBuildWindow/BundleBuildWindow.cs
// - Created:       ChenJC	
...
namespace CatAsset.Editor
{
    ...
    public class BundleBuildWindow : EditorWindow
    {
        ...
        [MenuItem("Frameworks/AssetBundle工具界面/打开资源包构建窗口", priority = 1)]

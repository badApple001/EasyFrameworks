//==========================
// - FileName:      Assets/Frameworks/Scripts/MultiLanguage/LanguageManager.cs
// - Created:       ChenJC	
...
public class LanguageManager
{
    ...
    private List<LanguageText> textComponents = new List<LanguageText>();
    public async Task<bool> Init()
    {
        ...
        var dataTable = await DataTableManager.Load<MultiLanguage>();
    ...
    public bool SetCurrentLanguage( string language )
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    Log.PINK( $"[{nameof( LanguageManager )}] 不存在多语言配置资源" );
                }
            }
        }
        return false;
    ...
    public void ___AddLanguageTextComponent( LanguageText languageText )
    {
    ...
    public void ___RemoveLanguageTextComponent( LanguageText languageText )
    {
        if ( textComponents.Contains( languageText ) )
        {

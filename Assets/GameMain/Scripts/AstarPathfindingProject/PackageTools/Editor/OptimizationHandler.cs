...
namespace Pathfinding {
	...
	public static class OptimizationHandler {
		...
		static Dictionary<BuildTargetGroup, List<string> > GetDefineSymbols () {
			...
			string defineString = PlayerSettings.GetScriptingDefineSymbolsForGroup(BuildTargetGroup.Android);
            result[ BuildTargetGroup.Android ] = defineString.Split( ';' ).Select( s => s.Trim( ) ).ToList( ); ;

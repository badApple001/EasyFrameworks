...
public class ExcelExport
{
    public static string exepath
    {
        get
        {
            return Path.GetFullPath( "Assets/Frameworks/Modules/DataTable/Editor/XlsxTransverter.exe" );
        }
    }
    public static string declare_dir_path { get { return Path.GetFullPath( "Assets/Frameworks/Modules/DataTable/Declare" ); } }
    public static string data_dir_path { get { return Path.GetFullPath( "Assets/Frameworks/Modules/DataTable/Resources/DR_Bytes" ); } }

//==========================
// - FileName:      Assets/Frameworks/Editor/UIScriptTemplate/HomeFormManager.cs
...
public class HomeFormManager
{
    ...
    public class DiskData
    {
        ...
        //你可以在这里自定义你当前界面的数据格式
        public int[] stageIndex = new int[ 2 ] { 1, 1 };
        public int[] globalIndex = new int[ 2 ] { 1, 1 };
    }
    ...
    public async void Open( )
    {
        ...
        //打开界面
        var form = UIManager.Open<HomeForm>( );
    ...
    public static HomeFormManager Instance { private set; get; } = new HomeFormManager( );
